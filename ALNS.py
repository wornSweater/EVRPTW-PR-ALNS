...
class ALNS:
    ...
    def run(
        ...
        return helper.total_distance_list(best_solution), len(best_solution), helper.total_distance_list(initial_solution), len(initial_solution), duration, best_solution
